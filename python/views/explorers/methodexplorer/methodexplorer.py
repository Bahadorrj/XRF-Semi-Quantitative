...
from python.views.explorers.methodexplorer.analytewidget import AnalytesAndConditionsWidget
from python.views.explorers.methodexplorer.calibrationwidget import CalibrationWidget
